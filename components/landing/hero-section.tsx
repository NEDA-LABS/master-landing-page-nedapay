...
// Dynamically import the globe (client-only canvas)
...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16 bg-white dark:bg-black">
      ...
      {/* Glow left */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] rounded-full bg-blue-500/5 dark:bg-blue-500/10 blur-3xl pointer-events-none" />
      {/* Glow right */}
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[300px] h-[300px] sm:w-[500px] sm:h-[500px] rounded-full bg-cyan-500/5 dark:bg-cyan-500/8 blur-3xl pointer-events-none" />
